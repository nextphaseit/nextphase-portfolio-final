...
import { Eye, EyeOff, Mail, Lock, ArrowLeft, AlertCircle, Building } from "lucide-react"
    ...
    if (oauthError) {
      switch (oauthError) {
        ...
        case "unauthorized_domain":
          setError("Access denied. Please use your company email address.")
          break
        case "token_failed":
        ...
        <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-primary/80 items-center justify-center p-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white max-w-md">
            ...
            <p className="text-lg opacity-90">
              We'll help you regain access to your Service Desk Portal account quickly and securely.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Client Access Portal</p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-primary/80 items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-md">
          ...
          <h2 className="text-3xl font-bold mb-4">Client Service Portal</h2>
          <p className="text-lg opacity-90 mb-8">
            Access your support tickets, resources, and account management tools in one secure location.
          </p>
          ...
          <div className="space-y-4 text-left">
            ...
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              <span>Access documentation and resources</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-white rounded-full"></div>
